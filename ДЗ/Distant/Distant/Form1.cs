    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonLevenshteinDist_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(word) && list.Count > 0)
            {
                ...
                foreach (var x in Result)
                {
                    ...
                    this.listBoxResult1.Items.Add(temp);
                }
        ...
        private void buttonSaveReport_Click(object sender, EventArgs e)
        {
            ...
            if (fd.ShowDialog() == DialogResult.OK)
            {
                ...
                b.AppendLine("<td>" + this.textBoxSearchTime.Text + "</td>");
                b.AppendLine("</tr>");
                ...
                b.AppendLine("<tr>");
                b.AppendLine("<td>Максимальное расстояние для параллельного поиска</td>");
                b.AppendLine("<td>" + this.textBoxMaxDist.Text + "</td>");
                b.AppendLine("</tr>");
                             
                b.AppendLine("<tr>");
                b.AppendLine("<td>Время параллельного поиска</td>");
                b.AppendLine("<td>" + this.textBoxParallTime.Text + "</td>");
                b.AppendLine("</tr>");
                ...
                foreach (var x in this.listBoxResult1.Items)
                {
                    b.AppendLine("<li>" + x.ToString() + "</li>");
                }
